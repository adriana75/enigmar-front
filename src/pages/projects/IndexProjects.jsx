                    ...
                    <tr key={p._id}>
                      ...
                      <td>
                        <DropDownOptions
                          id={p._id}
                          name="status"
                          options={Enum_statusProject}
                          currentValue={p.status}
                          mutation={EDITAR_PROYECTO_ESTADO}
                        />
                      </td>
                      <td>
                        <DropDownOptions
                          id={p._id}
                          name="phase"
                          options={Enum_phaseProject}
                          currentValue={p.phase}
                          mutation={EDITAR_PROYECTO_FASE}
                        />
                      </td>
                      <td>
                        <Link
  ...
  const submitForm = (e) => {
    ...
    if (name == "status") {
      Swal.fire({
        position: "center",
        icon: "success",
        title: `El estado del proyecto ha sido modificado exitosamente!`,
      ...
      Swal.fire({
        position: "center",
        icon: "success",
        title: `La fase del proyecto ha sido modificada exitosamente!`,
        showConfirmButton: true,
        //timer: 1500,
      });
      history("/proyectos");
